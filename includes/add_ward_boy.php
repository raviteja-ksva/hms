<?php
	...
	{
		$msg=$errors;
	   header('Location: ../reg_ward_boy.php?error='.urlencode($msg));
	    echo $errors;
	}
	...
	$query="INSERT INTO ward_boy (`wb_name`, `address`, `contact`, `salery`, `dob`, `shift`) VALUES ('$name', '$address', '$phone_no', '$salary', '$dob', '$shift');";
	echo $query;
	if(mysql_query($query))
	{
		// echo 'inerted';
		$wb_id = mysql_insert_id();
		$status = "Ward boy record added successfull.\\nWard boy Registration Number = " . $wb_id;
