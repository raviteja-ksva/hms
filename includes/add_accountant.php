<?php
	...
	{
		$msg=$errors;
	    header('Location: ../reg_accountant.php?error='.urlencode($msg));
	    echo $errors;
	}
	...
	$query="INSERT INTO accountant (`accountant_name`, `address`, `contact`, `dob`, `salery`) VALUES ('$name', '$address', '$phone_no',  '$dob', '$salary');";
	echo $query;
	if(mysql_query($query))
	{
		// echo 'inerted';
		$accountant_id = mysql_insert_id();
		$status = "Accountant record added successfull.\\nAccountant Registration Number = " . $accountant_id;
