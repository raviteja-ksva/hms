<?php
	...
	{
		$msg=$errors;
	   header('Location: ../reg_pharmacist.php?error='.urlencode($msg));
	    echo $errors;
	}
	...
	$query="INSERT INTO pharmacist (`ph_name`, `address`, `contact`, `salery`, `dob`) VALUES ('$name', '$address', '$phone_no', '$salary', '$dob');";
	echo $query;
