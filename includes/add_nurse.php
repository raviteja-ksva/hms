<?php
	...
	{
		$msg=$errors;
	   header('Location: ../reg_nurse.php?error='.urlencode($msg));
	    echo $errors;
	}
	...
	$query="INSERT INTO nurse (`nrs_name`, `address`, `contact`, `salery`, `dob`, `shift`) VALUES ('$name', '$address', '$phone_no', '$salary', '$dob', '$shift');";
	echo $query;
	if(mysql_query($query))
	{
		// echo 'inerted';
		$nrs_id = mysql_insert_id();
		$status = "Nurse record added successfull.\\nNurse Registration Number = " . $nrs_id;
