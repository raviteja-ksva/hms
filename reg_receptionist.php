...
<html>
    ...
    ?>
        <div id="container">
            <form action="includes/add_receptionist.php"  method="POST" >
                <h1>Register Receptionist</h1>
                <div class="line"><label for="username">Nurse Name: </label><input type="text" id="username" name='username'></div>
                ...
                <input type="radio" name="shift" value="evening">Evening
                 <input type="radio" name="shift" value="night">Ncight
