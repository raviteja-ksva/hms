...
$query = "select t1.doctor_name, t1.dob , t1.address,t1.contact, t1.designation,t1.type,t2.start_time,t2.end_time  from doctor as t1, doctor_slot as t2 where t1.doctor_id=t2.doctor_id ;";
//echo $query . "<br/>";
$result = mysql_query($query);

echo '<table border="1">';
echo '<tr><th>Doctor name</th><th>Date of birth</th><th>Address</th><th>Contact</th><th>Designation</th><th>type</th><th>start time</th><th>end time</th></tr>';
